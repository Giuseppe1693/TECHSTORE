        ...
        {cart.length === 0 ? (
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="bg-white text-black rounded-xl shadow-2xl p-6 text-center mt-6">
              <h2 className="text-2xl font-bold">Totale: €{formatEuro(total)}</h2>
              <button className="mt-4 bg-yellow-300 text-black font-semibold px-6 py-2 rounded-lg hover:bg-yellow-200 hover:scale-105 transition shadow-md">
